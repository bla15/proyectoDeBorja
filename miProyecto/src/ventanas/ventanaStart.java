...
public class ventanaStart  implements KeyListener, ActionListener{
	...
	int xOpciones=313;
	int yOpciones=226;
	int anchoBotonOptiocnes=50;
	int altoBotonOpciones=25;
	...
	private void initialize() {
		...
		frame.addComponentListener(new ComponentAdapter() {
			...
			public void componentResized(ComponentEvent e) {
				...
				bOptions.setBounds(frame.getWidth()*xOpciones/anchoFrame,frame.getHeight()*yOpciones/altoFrame,frame.getWidth()*anchoBotonOptiocnes/anchoFrame,frame.getHeight()*altoBotonOpciones/altoFrame);
				//bOptions.setFont(new Font("Stencil", Font.BOLD | Font.ITALIC, (frame.getHeight()+frame.getWidth())*tamañoLetraBoton/(anchoFrame+altoFrame)));
		...
		JlabelNombreCreadores = new JLabel("Por: Borja L\u00F3pez");
